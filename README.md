...
graph TD
    ...
    style Gmail fill:#eee,stroke:#333
    style Slack fill:#eee,stroke:#333
    style LLM fill:#eee,stroke:#333
```
...
2. Set up Supabase project with schema migrations
3. Configure OAuth applications (Google, Slack)
4. Implement MVP core (Auth → Sync → Draft → Send)
